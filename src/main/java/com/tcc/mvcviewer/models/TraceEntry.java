...
public class TraceEntry {
	...
	private void initEntry() {
		setxMin(getFile().getNextInteger());
		setyMin(getFile().getNextInteger());
		setxMax(getFile().getNextInteger());
		setyMax(getFile().getNextInteger());
		setRefPoc(getFile().getNextInteger());
		setRefView(getFile().getNextInteger());
		setxMb(getFile().getNextInteger());
		setyMb(getFile().getNextInteger());
		setCurrPoc(getFile().getNextInteger());
		setCurrView(getFile().getNextInteger());
		setMbType(getFile().getNextInteger());
		getFile().skipLine();
	}
